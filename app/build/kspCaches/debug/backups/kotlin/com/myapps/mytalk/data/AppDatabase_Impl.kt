...
public class AppDatabase_Impl : AppDatabase() {
  ...
  protected override fun createOpenDelegate(): RoomOpenDelegate {
    val _openDelegate: RoomOpenDelegate = object : RoomOpenDelegate(1,
        "270e03dca3801102fa777a47768a3056", "4e3b304e92b48eeb9f8ddfaab319c554") {
      public override fun createAllTables(connection: SQLiteConnection) {
        connection.execSQL("CREATE TABLE IF NOT EXISTS `users` (`id` BLOB NOT NULL, `name` TEXT NOT NULL, PRIMARY KEY(`id`))")
        connection.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)")
        connection.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '270e03dca3801102fa777a47768a3056')")
      }
      ...
      public override fun onValidateSchema(connection: SQLiteConnection):
        ...
        _columnsUsers.put("id", TableInfo.Column("id", "BLOB", true, 1, null,
        ...
        if (!_infoUsers.equals(_existingUsers)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |users(com.myapps.mytalk.data.models.User).
              | Expected:
